...
namespace WxPayAPI
{
    ...
    */
    public class WxPayConfig
    {
        ...
        */
        public static string NOTIFY_URL = System.Web.Configuration.WebConfigurationManager.AppSettings["NOTIFY_URL"]; 

        //=======【商户系统后台机器IP】===================================== 
        /* 此参数可手动配置也可在程序中自动获取
        */
        public static string IP = System.Web.Configuration.WebConfigurationManager.AppSettings["IP"];
