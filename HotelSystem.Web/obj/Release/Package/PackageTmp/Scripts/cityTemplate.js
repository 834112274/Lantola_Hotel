...
inCity.hotCitys = ['北京|beijing|bj', '上海|shanghai|sh', '重庆|chongqing|cq', '深圳|shenzhen|sz', '广州|guangzhou|gz', '杭州|hangzhou|hz',
...
inCity.cityClick = function ($this) {
    $(".city_a_le1 a").click(function () {
        ...
        window.location = "/Home/Search?city=" + a_city;
        return false;
    })
}